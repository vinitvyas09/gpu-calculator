...
| [x] Megatron Core Parallel State (NVIDIA/Megatron-LM)             | [https://github.com/NVIDIA/Megatron-LM/blob/main/megatron/core/parallel_state.py](https://github.com/NVIDIA/Megatron-LM/blob/main/megatron/core/parallel_state.py)                                                                                                                               | CP rank grouping and DP+CP weight-gradient communication        |
| [x] Megatron Bridge Parallelisms (NVIDIA Docs)                    | [https://docs.nvidia.com/nemo/megatron-bridge/latest/parallelisms.html](https://docs.nvidia.com/nemo/megatron-bridge/latest/parallelisms.html)                                                                                                                                                   | Distributed optimizer and TP/PP/CP semantics                    |
...
| [x] ZeRO: Memory Optimizations (Rajbhandari et al., 2019)                       | [https://arxiv.org/abs/1910.02054](https://arxiv.org/abs/1910.02054) | Memory partitioning formulas for optimizer states, gradients, parameters    |
